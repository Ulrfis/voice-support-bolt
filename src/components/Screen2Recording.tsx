...
import { waitForGami, connectGami, disconnectGami, PORTAL_IDS, mapStructToTicket, type GamiSDK } from '../lib/gamilab';
  ...
  useEffect(() => {
    ...
    const init = async () => {
      try {
        ...
        console.log('[Gamilab] disconnect (reset)...');
        await disconnectGami();
        if (!mounted) return;
